...
echo "Running benchmark for hnsw_pq with pq_m = 60, pq_bits = 16"
...
echo "Running benchmark for hnsw_pq with pq_m = 60, pq_bits = 32"
...
echo "Running benchmark for hnsw_pq with pq_m = 16, pq_bits = 64"
...
echo "Running benchmark for hnsw_pq with pq_m = 60, pq_bits = 64"
