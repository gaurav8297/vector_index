...
echo "Running benchmark for hnsw_pq with pq_m = 16, pq_bits = 10"
...
echo "Running benchmark for hnsw_pq with pq_m = 16, pq_bits = 12"
...
echo "Running benchmark for hnsw_pq with pq_m = 30, pq_bits = 10"
...
echo "Running benchmark for hnsw_pq with pq_m = 30, pq_bits = 12"
